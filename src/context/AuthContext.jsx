  ...
  const loginWithDemoRole = (role = "vendor", customData = {}) => {
    const demoProfiles = {
      vendor: {
        uid: "demo_vendor_001",
        name: "Rajesh Sharma",
        businessName: "Sharma Metals & Scrap Yard",
        phone: "+91 98112 34567",
        email: "rajesh@sharmametals.in",
        role: "vendor",
        city: "Mandi Gobindgarh",
        state: "Punjab",
        approxLocation: "Industrial Area, Mandi Gobindgarh",
        privateAddress: "Plot 42-B, Focal Point, Mandi Gobindgarh, PB - 147301",
        gstin: "03AABCS1429B1Z8",
        ...
        ratingSummary: { average: 4.9, count: 38 },
        notificationPreferences: {
          whatsappOptIn: true,
          dailyPriceDigest: true,
          orderAlerts: true
      ...
      dealer: {
        ...
        businessName: "Singhania Steel & Alloys Ltd",
        ...
        privateAddress: "C-12, Mayapuri Industrial Area, New Delhi - 110064",
