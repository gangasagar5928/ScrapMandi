    ...
    <header className="sticky top-0 z-40 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-sm">
      ...
      <div className="bg-slate-900 text-slate-200 text-xs px-4 py-1.5 font-medium flex justify-between items-center">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center px-1.5 py-0.5 rounded bg-emerald-500/20 text-emerald-400 text-[10px] font-bold tracking-wide uppercase">
            Delhi NCR Mandi
          </span>
          <span className="hidden sm:inline text-slate-300 text-[11px]">
            Mayapuri • Mundka • Bawana • Wazirpur • Okhla • Naraina • Sahibabad • Faridabad
          </span>
        </div>
        <div className="flex items-center gap-4 text-xs">
          <span className="flex items-center gap-1 text-emerald-400 font-medium text-[11px]">
            <ShieldCheck className="w-3.5 h-3.5" />
            Verified Dharam Kanta & Yard Gate Delivery
          </span>
        </div>
      </div>
              ...
              {showNotifMenu && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-slate-200 p-3 z-50 text-left">
                  <div className="flex items-center justify-between pb-2 border-b border-slate-100">
                    <span className="text-xs font-bold text-slate-900">Delhi Mandi Alerts</span>
              ...
              <div className="flex items-center gap-2 pl-2 border-l border-slate-200">
                <div className="text-right">
                  ...
                  <div className="text-[10px] text-slate-500 flex items-center gap-1 justify-end font-medium">
                    ...
                    {userProfile?.city || "Mayapuri, Delhi"}
                  </div>
                </div>
                <button
                  onClick={logOut}
